...
teste: ${so_file}
	${ts} psql ${tsparams} ${localparams} -c "SELECT * FROM groups_eci(array(SELECT name FROM country_group), 1998, hs_digit_pairs => 1);"
...
${so_file}: trading.o
	g++ -shared trading.o -I${pg13} -o ${so_file} ${static}
